...
class WaymoParser(ParserBase):
    """Parser for Waymo careers (Greenhouse-based, requires browser rendering)."""
    ...
    def fetch_and_parse(self) -> List[JobPosting]:
        ...
        logger.info(f"[{self.site_name}] Fetching Waymo careers via browser...")
